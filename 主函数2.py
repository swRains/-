...
path = 'F:/毕业设计库/测试数据/{:s}/{}/2/'.format(localtime, m_s)  # 路径地址，自定义
mkdir(path)  # 创建路径
# 读取20个氨基酸粗粒文件
pl = np.loadtxt('{}protein_ele.txt'.format(basic_path), dtype=str)  # protein list
...
note.write('tome' + ' ' + 'step' + ' ' + 'm' + ' ' + 'Move' + ' ' + 'energy' + ' ' + 'RMSD' + '\n')
sy.write(time_all + '\n' + 'Description :' + '\n')
sy.close()
